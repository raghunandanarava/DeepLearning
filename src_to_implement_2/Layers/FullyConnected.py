...
class FullyConnected:
    ...
    def __init__(self, input_size, output_size):
        ...
        self.initialize(weights_initializer=UniformRandom(), bias_initializer=Constant())
    ...
    def initialize(self, weights_initializer, bias_initializer):
        weights = weights_initializer.initialize((self.input, self.output), self.input, self.output)
        bias = bias_initializer.initialize((1, self.output), self.input, self.output)
